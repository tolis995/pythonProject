...
test1 = models.execute_kw(db, uid, password, 'account.move.line', 'fields_get', [])
fields=[]
values=[]
for x in test1:
    fields.append(x)
...
ids = models.execute_kw(db, uid, password, 'account.move.line', 'search', [[['date', '=', '2023-02-01']]], {'limit' : 10})
...
test2 = models.execute_kw(db, uid, password, 'account.move.line', 'read', [ids],
                          {'fields': ['move_id', 'move_name', 'date', 'ref']})
#
print(ids)
